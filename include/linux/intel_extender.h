...
struct extender_el1 {
	/* el1 virt area start (EXTENDER_START)*/
	void __iomem *extender_start;
	/* el1 virt area size (EXTENDER_SIZE) */
	unsigned long extender_size;
	/* serialize el1 pagefaults */
	spinlock_t lock;
	/* list head for free_list */
	struct list_head free_list;
	/* list head for allocated */
...
struct extender_el0 {
	...
	struct list_head allocated_list;/* see comments above */
};
